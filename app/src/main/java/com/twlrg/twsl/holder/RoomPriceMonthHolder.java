...
import com.twlrg.twsl.adapter.RoomPriceDayAdapter;
 ...
 *
 */
public class RoomPriceMonthHolder extends RecyclerView.ViewHolder
{
    private RecyclerView mRecyclerView;
    private TextView     mMonthTv;
    private Context      context;

    public RoomPriceMonthHolder(View itemView, Context context)
    {
        super(itemView);
    ...
    public void setData(RoomMonthInfo mRoomMonthInfo, MyItemClickListener listener)
    {
        ...
        mRecyclerView.setAdapter(new RoomPriceDayAdapter(mRoomMonthInfo.getRoomDayInfoList(), context, listener));
    }
