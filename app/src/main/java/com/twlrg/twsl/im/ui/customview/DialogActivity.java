package com.twlrg.twsl.im.ui.customview;
...
import com.twlrg.twsl.im.model.FriendshipInfo;
import com.twlrg.twsl.im.model.GroupInfo;
...
public class DialogActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p.width = (int) (APPUtils.getScreenWidth(this)*0.75); // 宽度设置为屏幕的0.7
...
//                });
                ...
                LoginActivity.start(DialogActivity.this,true);
                finish();
                break;
            case R.id.btnCancel:
                //logout();
